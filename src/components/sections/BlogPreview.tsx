...
export default function BlogPreview() {
    ...
    return (
        <section id="blog" className="relative bg-secondary-background border-b-2 border-border py-24 overflow-hidden">
            <Star36 size={160} className="absolute -bottom-10 -left-10 text-border opacity-[0.05] pointer-events-none" />
